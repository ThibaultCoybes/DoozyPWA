  ...
  return (
    <div className={styles.authContainer}>
      <div className={styles.logoContainer}>
        ...
        />
        <p className={styles.tagline}>Partagez vos créations avec le monde</p>
      </div>
      ...
      <div className={styles.formCard}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button 
            type="button" 
            onClick={() => {
              setEmail('user@doozy.com');
              setPassword('password123');
              // Soumettre le formulaire après un court délai pour que les états soient mis à jour
              setTimeout(() => {
          ...
          <p className={styles.switchLink}>
            ...
            <a href="/auth/register" className={styles.switchLinkText}>
              S'inscrire
            </a>
          </p>
        </form>
        ...
        <div className={styles.socialButtonsContainer}>
          <p className={styles.socialButtonsLabel}>Ou connectez-vous avec</p>
          <div className={styles.socialButtons}>
            <button className={styles.socialButton} type="button" aria-label="Se connecter avec Google">
            ...
            <button className={styles.socialButton} type="button" aria-label="Se connecter avec Facebook">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className={styles.socialButton} type="button" aria-label="Se connecter avec Twitter">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
